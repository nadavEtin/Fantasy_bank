...
namespace Editor
{
    ...
    public class StoryEventEditor : EditorWindow
    {
        ...
        private static void Init()
        {
            ...
            StoryEventEditor window = (StoryEventEditor)GetWindow(typeof(StoryEventEditor));
            window.Show();
        }
        ...
        private void Save()
        {
            ...
            {
                case 1:
                    var loanStoryEv = new LoanStoryDataSerialized(eventId, eventDuration, type, eventRequirementsList, eventName, eventText, resolutionName, resolutionText, loanCost, chanceOfSuccess);
                    _storiesRefs.SaveStory(loanStoryEv, StoryType.Loan);
                    break;
                default:
                    var regStoryEv = new EventDataSerialized(eventId, eventDuration, type, eventRequirementsList, eventName, eventText, resolutionName, resolutionText);
                    _storiesRefs.SaveStory(regStoryEv, StoryType.Other);
                    break;
            }
        }
