...
namespace GameEvent
{
    public class StoryEventManager : IGameEventManager, IDisposable
    {
        ...
        public StoryEventManager(IAssetRefs assetRefs, IInputManager inputManager, IBaseFactory storyViewFactory,
